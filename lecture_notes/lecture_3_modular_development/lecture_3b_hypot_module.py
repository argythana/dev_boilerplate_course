...
def hypot_calculator_modular():
    """Ask for triangle sides, calculate and PRINT hypotenuse. Works if input is numerical."""
...
if __name__ == "__main__":  # syntax for stand alone executable script.
    ...
    print(
        "Wow, a stand-alone script? Wow! Now you are only 984 steps away from becoming a developer.\
